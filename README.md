...
Setup & Run
Ensure the trained model (model.pkl) is in the /models directory (it is generated by the notebooks).
...
python app.py
Access the predictor in your browser at: http://127.0.0.1:5000/

## 📚 Notebooks

The project workflow is detailed across these Jupyter Notebooks:

* **[01_EDA_Preprocessing.ipynb](https://github.com/pandakitty/housingpricestoolw-Python/blob/main/notebooks/01_EDA_Preprocessing.ipynb)**: Data cleaning, exploratory data analysis (EDA), and feature engineering process.
* **[02_Model_Training.ipynb](https://github.com/pandakitty/housingpricestoolw-Python/blob/main/notebooks/02_Model_Training.ipynb)**: Regression modeling, hyperparameter tuning, model comparison, and final evaluation metrics.
